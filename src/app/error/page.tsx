...
export const metadata: Metadata = {
  ...
  description: '覆盖 401、403、404 model not found、429、timeout、insufficient quota、invalid API key 和 Base URL 配置错误的排查与修复示例。',
  alternates: {
    canonical: 'https://apiuspro.cn/error',
  },
  openGraph: {
    title: 'API 错误解决指南',
    description: 'AI API 常见错误的真实排查清单、平台特殊情况和可复制修复示例。',
