...
export const reviewDetails: Record<string, ReviewDetail> = {
  ...
  deepseek: {
    ...
    tlDr:
      'DeepSeek 是预算敏感开发者非常值得优先测试的 API。代码、推理和中文技术问答表现突出，OpenAI 兼容接入简单，适合编程助手、技术问答和 Claude Code 后端模型。',
    ratings: [
      { label: '质量', score: 4.6, detail: '代码、推理和中文技术问题表现强，通用对话也足够稳定。' },
      { label: '速度', score: 4.4, detail: '常规任务速度较好，复杂推理模型会消耗更多时间和 Token。' },
      { label: '性价比', score: 5.0, detail: '在同等能力区间内成本优势明显，适合大量开发测试。' },
      { label: '稳定性', score: 4.3, detail: '热门时段可能出现拥堵或限流，生产环境建议做好重试和降级。' },
    ],
    pros: [
      ...
      'OpenAI 兼容接口清晰，迁移成本低',
      '国内支付和访问门槛低，充值流程简单',
      '适合作为 Claude Code、Agent 工具和自动化脚本的后端模型',
    ],
    cons: [
      '热门模型在高峰期可能拥堵，需要做好超时、重试和备用模型',
      '多模态和完整云生态不如阿里、腾讯、字节等大云厂商全面',
      '模型名、价格和免费额度变动较快，接入前要核对控制台',
      '需要严格评估复杂推理输出的可靠性，关键业务不要无校验直接执行',
    ],
    useCases: [
      '代码助手：生成代码、解释报错、单元测试和重构建议',
      '技术问答：研发知识库、运维排障和文档问答',
      '低成本 Agent：命令行工具、自动化脚本和内部机器人',
      '预算敏感生产：在成本约束下追求较强模型能力',
      '不适合：需要最完整多模态生态或极高 SLA 的企业关键链路',
    ],
    conclusion:
      'DeepSeek 是“先测它不会错”的高性价比模型。对开发者尤其友好，但生产环境要准备限流重试、成本监控和备选模型，把性价比优势用稳。',
  },
